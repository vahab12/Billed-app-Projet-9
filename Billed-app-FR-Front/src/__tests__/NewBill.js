...
//Quand je suis sur la page de NewBill
//L'icône newBill dans la disposition verticale devrait alors être mise en évidence.
describe('Given I am connected as an employee', () => {
  describe('When I am on NewBill Page', () => {
    ...
    //Lorsque je remplis les champs dans le format correct et que je clique sur le bouton "Submit"
    //Le processus de soumission devrait alors fonctionner correctement, et je devrais être envoyé sur la page Bills.
    describe('When I do fill fields in correct format and I click on submit button', () => {
      ...
      //Alors un nouveau bill devrait être créé
    ...
    //Quand rien n'a été tapé dans l'entrée PCT
    //alors le PCT devrait être de 20 par défaut
    ...
    //Lorsque je ne remplis pas les champs et que je clique sur le bouton "Soumettre".
    //Ensuite, il devrait rester sur la page de la nouvelle facture
    ...
    // --------------------------------------------------------- //
    //When I am on NewBill page and I upload a file with an extension jpg, jpeg or png
    //Then no error message for the file input should be displayed
    ...
    //Ensuite, un nouveau bill est ajouté à l'API mais fetch échoue avec l'erreur "404 page not found".
    describe('When an error occurs on API', () => {
      ...
      //Ensuite, un nouveau bill est ajouté à l'API, mais fetch échoue avec le message "500 Internal Server error".
